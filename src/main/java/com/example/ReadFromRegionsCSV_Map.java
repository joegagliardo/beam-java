...
public class ReadFromRegionsCSV_Map {
	...
	public static void main(String[] args) {
		...
		ReadFromRegionsCSV_Map.buildPipeline(pipeline, inputFile, outputFolder);
...
// gradle run -PmainClass="com.example.ReadFromRegionsCSV" --args="--inputFile=data/regions.csv --outputFolder=tmp/regionsCSV_Map"

// gradle run -PmainClass="com.example.ReadFromRegionsCSV" --args="--inputFile=gs://joey-dataflow-bucket/data/regions.csv --outputFolder=gs://joey-dataflow-bucket/temp/regionsCSV_Map"

// gradle run -PmainClass="com.example.ReadFromRegionsCSV" --args="--inputFile=gs://joey-dataflow-bucket/data/regions.csv --outputFolder=gs://joey-dataflow-bucket/temp/output/regionsCSV_Map --runner=DataflowRunner --project=joey-gagliardo --region=us-central1 --gcpTempLocation=gs://joey-dataflow-bucket/temp --dataflowServiceOptions=enable_prime"
